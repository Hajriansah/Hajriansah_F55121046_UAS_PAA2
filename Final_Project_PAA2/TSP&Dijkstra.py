...
def main():
    ...
    while True:
        ...
        if choice == 1:
            ...
            tsp_path, tsp_weight, tsp_time = traveling_salesman(graph, start_node)
            ...
            start_node = input("Pilih node Awal: ")
            end_node = input("Pilih node Akhir(Node yang akan dituju): ")
            dijkstra_path, dijkstra_weight, dijkstra_time = shortest_path(graph, start_node, end_node)
